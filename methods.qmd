...
-   $P(\theta | \text{Data})$ is the posterior, $P(\text{Data} | \theta)$ is the likelihood, $P(\theta)$ is the prior, and $P(\text{Data})$ is the marginal likelihood (normalizing constant).
...
#| tbl-cap: "A limited overview on viewpoints of Frequentist and Bayesian statistical approaches. (adapted from @harrell2024)"
#| tbl-colwidths: "auto"
#| echo: false
library(knitr)
library(kableExtra)
...
\footnotesize 
`r get_package_citations(package_type="all", output="text")` 
\normalsize
