...
As for definitions of diverse outcomes including disease criteria for delirium, pneumonia, sepsis, myocardial infarction, deep vein thrombosis, pulmonary embolism, and dementia it has to be mentioned that this was to the discretion of the treating physician following a well structured guideance of experienced stroke neurologists and a continously updating standard operating procedure for patients treated on the stroke unit. [@ringleb2022]
For delirium detection the CAM-ICU and ICDSC were the most commonly used tools throughout the year.
